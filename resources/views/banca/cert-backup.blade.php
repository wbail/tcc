...
<div class="container">
    ...
    <p class="text-justify">
        Declaro para os devidos fins que o(a) <strong>Professor(a) {{ $banca[0]->trabalho->membrobanca->user->name }}</strong>
        ...
        @else {{ $aluno[0] }}, @endif intitulado <strong>{{ $banca[0]->trabalho->titulo }}</strong>, no dia {{ \Carbon\Carbon::parse($banca[0]->data)->format('d/m/Y à\s H:i') }}. A banca foi
        constituída também pelos(as) Professores(as) {{ $membro[0] }} e {{ $membro[1] }}.
        <br>
        <br>
        <br><br><br>
        <br><br><br>
