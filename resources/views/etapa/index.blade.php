                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a id="{{ $etapa->id }}" class="btn btn-link" href="{{ route('etapa.edit', ['id'=>$etapa->id]) }}" title="Editar"><i class="fa fa-pencil"></i></a>
                                <button id="{{ $etapa->id }}" class="btn btn-link" data-toggle="modal" data-target="#myModalDelEtapa" title="Excluir"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
