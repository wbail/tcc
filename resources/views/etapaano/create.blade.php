    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
            	...
            	<div class="col-md-4">
            		{!! Form::open(['url' => '/etapaano/store', 'method'=>'post']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                {!! Form::text('data_inicial', null, ['class'=>'form-control', 'title'=>'Data de início da etapa', 'id'=>'datetimepicker']) !!}
                            </div> <!-- ./col-md-6 -->
                            <div class="col-md-6">
                                {!! Form::label('data_final', 'Data Final *') !!}
                                {!! Form::text('data_final', null, ['class'=>'form-control', 'title'=>'Data de término da etapa', 'id'=>'datetimepicker1']) !!}
                            </div> <!-- ./col-md-6 -->
                        </div> <!-- ./row -->
                        <br>
